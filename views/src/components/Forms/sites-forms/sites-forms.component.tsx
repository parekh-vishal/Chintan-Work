  ...
  return (
    <>
      <Modal.Header closeButton>
        <Modal.Title>{`${props.isReadOnly ? 'View' : (props.currentSite.siteId ? 'Edit':'New')} Site`}</Modal.Title>
      </Modal.Header>
      <Form onSubmit={formik1.handleSubmit}>
        <Modal.Body>
          <Form.Group controlId="siteName">
            <Form.Row>
              ...
              <Col>
                <Form.Control type="text" placeholder="Enter Site Name" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.siteName} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="ownerName">
            <Form.Row>
              ...
              <Col>
                <Form.Control type="text" placeholder="Enter Owner Name" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.ownerName} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="ownerContactNo">
            <Form.Row>
              ...
              <Col>
                <Form.Control type="number" placeholder="Enter Owner Contract No" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.ownerContactNo} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="AddressLine1">
            <Form.Row>
              ...
              <Col>
                <Form.Control name="siteAddress.AddressLine1" as="textarea" placeholder="Enter site address" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.siteAddress.AddressLine1} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="City">
            <Form.Row>
              ...
              <Col>
                <Form.Control name="siteAddress.City" type="text" placeholder="Enter City" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.siteAddress.City} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="State">
            <Form.Row>
              ...
              <Col>
                <Form.Control type="text" name="siteAddress.State" placeholder="Enter State" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.siteAddress.State} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="pincode">
            <Form.Row>
              ...
              <Col>
                <Form.Control type="number" name="siteAddress.pincode" placeholder="Enter Pincode" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.siteAddress.pincode} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="siteInaugurationDate">
            <Form.Row>
              ...
              <Col>
                <DatePicker selected={formik1.values.siteInaugurationDate} onChange={(date) => formik1.setFieldValue('siteInaugurationDate', date)} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="siteEstimate">
            <Form.Row>
              ...
              <Col>
                <Form.Control type="number" placeholder="Enter Estimate" onChange={formik1.handleChange} onBlur={formik1.handleBlur} value={formik1.values.siteEstimate} readOnly={props.isReadOnly}/>
          ...
          <Form.Group controlId="tentativeDeadline">
            <Form.Row>
              ...
              <Col>
                <DatePicker selected={formik1.values.tentativeDeadline} onChange={(date) => formik1.setFieldValue('tentativeDeadline', date)} readOnly={props.isReadOnly}/>
        ...
        <Modal.Footer>
          ...
          {!props.isReadOnly && <Button variant="primary" type="submit">{`${props.currentSite.siteId ? 'Edit':'Create'}`}</Button>}
        </Modal.Footer>
      </Form>
    </>
  );
